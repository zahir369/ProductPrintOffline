...
namespace MKSS.Model
{
	...
	public class Sensor
	{
        ...
        public static string CreateCensorId(long batch_no, int floorNo, string boardNO, int posNo)
        {
            return (string.Format("{0}{1}{2}{3}", batch_no, floorNo.ToString("00"), boardNO, posNo.ToString("00")));
        }
