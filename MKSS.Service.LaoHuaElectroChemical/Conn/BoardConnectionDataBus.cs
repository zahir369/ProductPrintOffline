...
namespace MKSS.Service.LaoHua
{
	...
	public class BoardConnectionDataBus : BoardConnection
	{
		...
		public BoardConnectionDataBus(DataBus databus, List<byte> addr,int readspeed =200) :base(readspeed) {
			DataBus = databus; Addr = addr;
