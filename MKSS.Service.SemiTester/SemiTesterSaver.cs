...
namespace MKSS.Service.SemiTester
{
    public class SemiTesterSaver
	{
		...
		public static string DbNameof(Batch _bat) {
			...
			return string.Format(string.Format(AppDomain.CurrentDomain.BaseDirectory + @"data\MKSS.APP.SemiTester.{0}.sqlite", _bat.F_BatchId));
		}
		...
		public static Batch Batch
		{
			...
			set
			{
				//DataSource=D:\WORK\Factory\MKSS.APP.SemiTester\bin\Debug\net5.0-windows\MKSS.APP.SemiTester.sqlite
				if (value != null) {
