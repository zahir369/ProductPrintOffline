...
namespace MKSS.Services.BASE
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        /// <param name="parameters">参数</param>
        /// <returns>DataTable</returns>
        public async Task<int> ExecuteCommand(string strSql, SugarParameter[] parameters = null)
        {
            return await BaseDal.ExecuteCommand(strSql, parameters);
