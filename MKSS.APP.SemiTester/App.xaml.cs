...
namespace DeviceDataMonitorWPF
{
    ...
    public partial class App : Application
    {
        ...
        {
            Log("enter");
            ULogger.OnErrorLicense += ULogger_OnErrorLicense;
            ULogger.Log("enter");
            ...
            if (e.Args != null)
            {
                ...
                {
                    if (item.ToLower() == "Version3V".ToLower())
                    {
                        SemiTesterService.Version3V = true;
                    }
                }
            }

            SemiTesterService.Debug = Appsettings.App(new string[] { "Debug" }).ObjToString().ToLower()=="true";
        ...
        private void ULogger_OnErrorLicense(string srcPath,string msg)
        {
            //Log("error :環境 dll 缺失，"+ msg);
            //System.Environment.Exit(1);
        }
