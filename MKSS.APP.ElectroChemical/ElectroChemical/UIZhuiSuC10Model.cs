...
namespace MKSS.APP.ElectroChemical
{
    ...
    public class UIZhuiSuC10Model {
        ...
        public MKSS.Service.ElectroChemical.ElectroChemicalService ECService { get; set; }

        public UIZhuiSuC10Model() {
            Instance = this;
            ECService = new Service.ElectroChemical.ElectroChemicalService();
            ECService.OnNewData += ElectroChemicalService_OnNewData;
        ...
        void ElectroChemicalService_OnNewData(Model.Batch _Batch, MKSS.Model.SensorGroupData datas_history,TimeSpan F_AddTime)
        {
