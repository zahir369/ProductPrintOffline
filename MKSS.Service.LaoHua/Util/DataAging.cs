...
namespace MKSS.Service.LaoHua.Util
{
	...
	public class DataAging
	{
		...
		public ModBusBoardConnection ModBusBoardConfig { get; set; }
		...
		public void Reset(List<TaskAddress> address)
		{
            foreach (var item in address)
            {
				int boardNo = (int)item.Address;
				if (DataAgingSensorCache.ContainsKey(boardNo))
				{
		...
		public DataAging(ModBusBoardConnection config)
		{
			ModBusBoardConfig = config;
		}
