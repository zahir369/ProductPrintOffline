...
namespace MKSS.APP.SemiCatalysis
{
    public class UIZhuiSuC10SettingModel: INotifyPropertyChanged {
		...
		public bool CanTxtZeroTime { get { return !Started; } }
		...
		public int TxtGrading1From { get { var g = OfGrade(1); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(1, value, false); } }
		public int TxtGrading2From { get { var g = OfGrade(2); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(2, value, false); } }
		public int TxtGrading3From { get { var g = OfGrade(3); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(3, value, false); } }
		public int TxtGrading4From { get { var g = OfGrade(4); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(4, value, false); } }
		public int TxtGrading5From { get { var g = OfGrade(5); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(5, value, false); } }
		public int TxtGrading6From { get { var g = OfGrade(6); return g == null ? 0 : g.From; } set { var g = OfGradeSetFrom(6, value, false); } }


		public int TxtGrading1To { get { var g = OfGrade(1); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(1, value, false); } }
		public int TxtGrading2To { get { var g = OfGrade(2); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(2, value, false); } }
		public int TxtGrading3To { get { var g = OfGrade(3); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(3, value, false); } }
		public int TxtGrading4To { get { var g = OfGrade(4); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(4, value, false); } }
		public int TxtGrading5To { get { var g = OfGrade(5); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(5, value, false); } }
		public int TxtGrading6To { get { var g = OfGrade(6); return g == null ? 0 : g.To; } set { var g = OfGradeSetTo(6, value, false); } }

		public int TxtDtGrading1From { get { var g = OfGrade(1); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(1, value, true); } }
		public int TxtDtGrading2From { get { var g = OfGrade(2); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(2, value, true); } }
		public int TxtDtGrading3From { get { var g = OfGrade(3); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(3, value, true); } }
		public int TxtDtGrading4From { get { var g = OfGrade(4); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(4, value, true); } }
		public int TxtDtGrading5From { get { var g = OfGrade(5); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(5, value, true); } }
		public int TxtDtGrading6From { get { var g = OfGrade(6); return g == null ? 0 : g.DtFrom; } set { var g = OfGradeSetFrom(6, value, true); } }


		public int TxtDtGrading1To { get { var g = OfGrade(1); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(1, value, true); } }
		public int TxtDtGrading2To { get { var g = OfGrade(2); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(2, value, true); } }
		public int TxtDtGrading3To { get { var g = OfGrade(3); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(3, value, true); } }
		public int TxtDtGrading4To { get { var g = OfGrade(4); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(4, value, true); } }
		public int TxtDtGrading5To { get { var g = OfGrade(5); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(5, value, true); } }
		public int TxtDtGrading6To { get { var g = OfGrade(6); return g == null ? 0 : g.DtTo; } set { var g = OfGradeSetTo(6, value, true); } }
		...
		ProductGrade OfGradeSetFrom(int i, int vv,bool dt =false)
		{
			var g = OfGrade(i);
			if (!dt) g.From = vv;
			if (dt) g.DtFrom = vv;
		...
		ProductGrade OfGradeSetTo(int i, int vv, bool dt = false)
		{
			var g = OfGrade(i);
			if (!dt) g.To = vv;
			if (dt) g.DtTo = vv;
		...
		public void CalcHeGe()
		{
			...
			try
			{
				if (ProductConfig == null || UIZhuiSuC10Model.Instance.ECService.BatchSensorDataLastDictionary == null) 
					return;
				foreach (var item in UIZhuiSuC10Model.Instance.ECService.BatchSensorDataLastDictionary.Values)
				{
					var vv = item.F_ShowValue;
