...
namespace DeviceDataMonitorWPF.UIBiaoDing
{
    public class UIBoardCaseSelectEntity
    {
        ...
        public void Init() {
            ...
            if (DBListBoard == null)
            {
                DBListBoard = UISheBeiBiaoDingViewModel.Intance.ScrwdService.db.Ado.SqlQuery<Board>("select * from pd_board");
                DBListBoardCase = UISheBeiBiaoDingViewModel.Intance.ScrwdService.db.Ado.SqlQuery<BoardCase>("select * from pd_boardcase");
                DBListDataBus = UISheBeiBiaoDingViewModel.Intance.ScrwdService.db.Ado.SqlQuery<DataBus>("select * from pd_databus");
