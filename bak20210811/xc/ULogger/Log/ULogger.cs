...
namespace MKSS.Util.Log
{
    ...
    public class ULogger
    {
        ...
        {
            string dir = MKSS.Util.Log.ULogger.StartupWebRoot + "\\App_log\\" ;
        ...
        public static string CurrentLogFile(string title) {
            string dir = MKSS.Util.Log.ULogger.StartupWebRoot + "\\App_log\\" + DateTime.Now.ToString("yyyyMMdd") + "\\";
            if (!System.IO.Directory.Exists(dir))
            {
                Directory.CreateDirectory(dir); 
                //if (LoggerEf != null)
            ...
            try
            {
                ...
                if (!LogToFileIgnore)
                {
                    ...
                    if (log_to_file)
                    {
                        ...
                        string dir_yesterday = MKSS.Util.Log.ULogger.StartupWebRoot + "\\App_log\\" + yesterday.ToString("yyyyMMdd") + "";
