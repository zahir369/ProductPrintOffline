...
namespace DeviceDataMonitorWPF.UIBiaoDing.Signal
{
	...
	**/
	public class WX94_WriteSerialNo : ISignal
	{
		...
		{
			if (SerialNo > 999999999999 || SerialNo<= 200000000000) {
				throw new Exception("串号【"+ SerialNo + "】必须小于999999999999，大于 200000000000");
			}
			...
			arr[0] = BitConverter.ToUInt16(new byte[] { (byte)0X94, (byte)0X00 }, 0);
