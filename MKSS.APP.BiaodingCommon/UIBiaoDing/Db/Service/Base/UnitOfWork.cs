...
namespace MKSS.Common
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public SqlSugarClient GetDbClient()
        {
            ...
            string connstr = "Data Source=" + BiaoDingSaver.DbNameof(BiaoDingSaver.Batch) + ";Version=3";
            DbType _DbType = APP.UIBiaoDing.Config.BiaoDingConfgig.Instance.RunModeOnline ? DbType.MySql : DbType.Sqlite;
            ...
            if (APP.UIBiaoDing.Config.BiaoDingConfgig.Instance.RunModeOnline) {
                ...
                // 明文
                var configStr1 = helper.Decrypto(ConfigurationManager.AppSettings["Connection"]);
                var configStr2 = helper.Decrypto(ConfigurationManager.AppSettings["ScrwdConnection"]);

                // 明文 
                if ((ConfigurationManager.AppSettings["ConnectionEncrypt"] + "").ToLower() == "true") connstr = helper.Decrypto(ConfigurationManager.AppSettings["Connection"]); 
