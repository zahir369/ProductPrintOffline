...
namespace MKSS.APP.UIBiaoDing
{
    public class UISheBeiBiaoDingViewModel : Screen 
	{
		...
		public static int MaxBoardCount = 180;
		...
		public bool TaskOpened { get; set; }
		...
		public bool CanBtnJudge { get { return TaskStarted || TaskOpened; } }
		public bool CanBtnExport { get { return TaskStarted || TaskOpened; } }
		public bool CanBtnExportQRCodeExcel { get { return TaskStarted || TaskOpened; } }
		public bool CanBtnExportHistoryDataSelect { get { return TaskStarted || TaskOpened; } }

		public bool CanBtnTaskStart { get { return !TaskStarted; } }
		public bool CanBtnTaskEnd { get { return TaskStarted; } }
		public bool CanTxtPortsModeSelect { get { return !TaskStarted && !ConnIsOpen; } }
		public bool CanTxtSerialPorts { get { return !TaskStarted && !ConnIsOpen; } }
		public bool CanTxtTCPIP { get { return !TaskStarted && !ConnIsOpen; } }
		public bool CanTxtProductList { get { return !TaskStarted && !ConnIsOpen; } }
		public bool CanTxtValueBase { get { return TaskStarted; } }
		public bool CanTxtValueAdd { get { return TaskStarted; } }
		public bool CanTxtValueMinus { get { return TaskStarted; } }
		public bool CanTxtSensorGrougAddress { get { return !TaskStarted && !ConnIsOpen; } }
		public bool CanTxtTimeTotal { get { return TaskStarted && !ConnIsOpen; } }
		public bool CanTxtTunnelList { get { return TaskStarted && !ConnIsOpen; } }
		public bool CanTxtTimeInterval { get { return TaskStarted && !ConnIsOpen; } }
		public bool CanTxtZreo { get { return TaskStarted && ConnIsOpen; } }
		public bool CanTxtSpan { get { return TaskStarted && ConnIsOpen; } }
		public bool CanTxtVoltageValueBase { get { return TaskStarted; } }
		public bool CanTxtVoltageValueMinus { get { return TaskStarted; } }
		public bool CanTxtVoltageValueAdd { get { return TaskStarted; } }

		public bool CanBtnConnect { get { return TaskStarted && !ConnIsOpen; } }
		public bool CanBtnDisConnect { get { return TaskStarted && ConnIsOpen; } }
		public bool CanBtnSetZero { get { return TaskStarted && ConnIsOpen; } }
		public bool CanBtnSetSpan { get { return TaskStarted && ConnIsOpen; } }
		public bool CanBtnModeSelfReport { get { return TaskStarted && ConnIsOpen; } }
		public bool CanBtnModeQuery { get { return TaskStarted && ConnIsOpen; } }
		public bool CanBtnQuery { get { return TaskStarted && ConnIsOpen && AddressAvaliable && !BtnQueryParameterIsRead; } }
		public bool CanBtnQueryParameter { get { return TaskStarted && ConnIsOpen && AddressAvaliable && !BtnQueryIsRead; } }
		public bool CanBtnSetSerialNo { get { return TaskStarted && ConnIsOpen && AddressAvaliable; } }
		public bool CanBtnSetTime { get { return TaskStarted && ConnIsOpen && AddressAvaliable; } }
		public bool CanBtnScrwd { get { return !TaskStarted && !ConnIsOpen; } }
		...
		///  串号缓存，为了查找串号重复
		/// </summary>
		public ConcurrentDictionary<string, SensorDataX> SerialCache = new ConcurrentDictionary<string, SensorDataX>();
	...
	;
		...
		public void PageContextLoadedAll( )
		{
			if (this.PageContext == null) return;
		...
		public void BtnTaskStart() {

			SaveConfig();
			this.ConnectionPool.Qualified.Clear();
			...
			List<Address> addrList = UISheBeiBiaoDingViewModel.Intance.CalcAddress();//必须调用一次，计算内存表
			if (addrList.Count == 0) {
				MessageBox.Show("请输入或选择有效地址或老化柜！");
				return;
			}
		...
		public void BtnTaskEnd()
		{

			WaitWindow.ShowWindow("正在停止任务", "正在停止数据通信......", PageContext);
			foreach (var conn in this.ConnectionPool.Values.ToList()) conn.CommFactory.DataEvent -= this.SM_DataEvent;
			foreach (var conn in this.ConnectionPool.Values.ToList()) conn.CommFactory.MessageEvent -= this.SM_MessageEvent;
			if (this.ConnIsOpen)
            {
			...
			WaitWindow.ShowWindow("正在停止任务", "正在存储数据......", PageContext);
			DbService.StopBatch();
			WaitWindow.ShowWindow("正在停止任务", "正在同步数据......", PageContext);
			try
            {
				this.SerialNoFactory.PushBatchData();
			}
            catch (Exception ex)
			{
				TaskStarted = false;
				WaitWindow.CloseWindow(PageContext);
				MessageBox.Show("同步数据出错",ex.Message);
				return;
            }
		...
		public async Task BtnSetZero()
		{
			...
			this.DbService.SetOperationTime("F_BD_ZERO_TIME",true);
		}
		...
		public async Task BtnSetSpan()
		{
			...
			this.DbService.SetOperationTime("F_BD_SPAN_TIME", true);
		}
   ...
   //         }
				...
				if (dlg.ShowDialog() == true)
				{
					...
					if (this.PageContext.TabControlMain.SelectedItem == this.PageContext.TabItemVoltage10) {
						try
						{
							...
							ETE.SetCellValue<DateTime>(hr, 2, batch.F_AgingStartTime, "yyyy-MM-dd HH:mm", hr, 3);
							ETE.SetCellValue<string>(hr, hrUser + 0, "操作人");
							ETE.SetCellValue<string>(hr, hrUser + 1, BiaoDingConfgig.Instance.TxtUser);
							ETE.SetCellValue<string>(hr, hrUser + 2, "核验人");
							ETE.SetCellValue<string>(hr, hrUser + 3, BiaoDingConfgig.Instance.TxtUserAdmin);

							ETE.SetCellValue<string>(hr + 1, 1, "位置");
							ETE.SetCellValue<string>(hr + 1, 2, "实时AD");
							ETE.SetCellValue<string>(hr + 1, 3, TitleFieldName[0]);
							ETE.SetCellValue<string>(hr + 1, 4, TitleFieldName[1]);
							ETE.SetCellValue<string>(hr + 1, 5, "预留1");
							ETE.SetCellValue<string>(hr + 1, 6, "预留2");
							ETE.SetCellValue<string>(hr + 1, 7, "预留3");
							ETE.SetCellValue<string>(hr + 1, 8, "浓度");
							ETE.SetCellValue<string>(hr + 1, 9, "温度1");
							ETE.SetCellValue<string>(hr + 1, 10, "温度2"); 
							ETE.SetCellValue<string>(hr + 1, 11, "模拟电压");
							ETE.SetCellValue<string>(hr + 1, 12, "是否合格");
							ETE.SetCellValue<string>(hr + 1, 13, "设备串号");
							ETE.SetCellValue<string>(hr + 1, 14, "设备时间");
					...
					if (this.PageContext.TabControlMain.SelectedItem == this.PageContext.TabItemVoltage)
					{
						try
						{
							...
							ETE.SetCellValue<string>(hr + 1, 3, TitleFieldName[0]);
							ETE.SetCellValue<string>(hr + 1, 4, TitleFieldName[1]);
							ETE.SetCellValue<string>(hr + 1, 5, "浓度");
							ETE.SetCellValue<string>(hr + 1, 6, "温度1");
							ETE.SetCellValue<string>(hr + 1, 7, "是否合格");
							ETE.SetCellValue<string>(hr + 1, 8, "设备串号");
							ETE.SetCellValue<string>(hr + 1, 9, "设备时间");
					...
					if (this.PageContext.TabControlMain.SelectedItem == this.PageContext.TabItemParamenter)
					{
						try
						{
							...
							ETE.SetCellValue<string>(hr, hrUser + 3, BiaoDingConfgig.Instance.TxtUserAdmin);
							ETE.SetCellValue<string>(hr + 1, 1, "位置");
							ETE.SetCellValue<string>(hr + 1, 2, "序列号");
							ETE.SetCellValue<string>(hr + 1, 3, "时间");
							ETE.SetCellValue<string>(hr + 1, 4, "量程");
							ETE.SetCellValue<string>(hr + 1, 5, "输出电压");
							ETE.SetCellValue<string>(hr + 1, 6, "电压范围");
							ETE.SetCellValue<string>(hr + 1, 7, "自校准"); 
		...
		public async Task BtnExportQRCodeExcel()
		{
			SaveConfig();
			try
			{
				//string.Format("#{0}#{1}" + (sn.APP > 0 ? "@" : ""), sn.ADDR, sn.POS)
				//ADDR = GroupData.Address.V,
    //                APP = GroupData.Address.APP,
    //                POS = row.WEIZHI
				Dictionary<string, string> posDic = new Dictionary<string, string>();
				for (int i = 0; i < this.ProductModelGroupTable.Count; i++)
				{
					SensorGroupDataModel mm = ProductModelGroupTable[i];
					if (mm.Address.V == 0) continue;
					for (int j = 0; j < mm.ProductTable.Count; j++)
					{
						var rowData = this.ProductModelGroupTable[i].ProductTable[j];
						string pos = string.Format("#{0}#{1}" + (mm.Address.APP > 0 ? "@" : ""), mm.Address.V, rowData.Position);
						if (string.IsNullOrEmpty(rowData.Serial)) continue;
						if (!posDic.ContainsKey(rowData.Serial)) posDic.Add(rowData.Serial, pos);
					}
				}

				string max = posDic.Max(w => w.Key);
				string min = posDic.Min(w => w.Key);
				if (string.IsNullOrEmpty(min) || string.IsNullOrEmpty(max)) return;
				long minLong = 0;
				long maxLong = 0;
				long.TryParse(min,out minLong);
				long.TryParse(max, out maxLong);
				if (maxLong - minLong > 3000) {
					MessageBox.Show("串号不正常，不连续，请检查串号是否合法", "读取二维码数据出错");
					return;
				}

				string name = string.Format("{0}-{1}", min, max);
				DataTable table = null;
				Dictionary<string, DataRow> DataRowDic = new Dictionary<string, DataRow>();
				try
                {

					string sql= @"SELECT p.F_SerialNO,concat(p.F_SerialNO,';',p.F_SerialValidCode) PRINT_CDOE,p.F_SerialValidCode,sc.F_IMEI,sc.F_IMSI,sc.F_ICCID FROM `pd_sensor_scrwd` p
									left join pd_device sc on sc.F_SerialNO=p.F_SerialNO
									where  p.F_SerialNO>={0}   and p.F_SerialNO<={1} order by p.F_SerialNO";
					sql = string.Format(sql, min, max);
					table = this.SerialNoFactory.GetDataTable(sql);

					for (int i = 0; i < table.Rows.Count; i++)
					{
						DataRow dr = table.Rows[i]; 
						string F_SerialNO = dr["F_SerialNO"] + "";
						if (string.IsNullOrEmpty(F_SerialNO)) continue;
						if (!DataRowDic.ContainsKey(F_SerialNO)) DataRowDic.Add(F_SerialNO, dr);
					}

				}
                catch (Exception ex)
                {
					MessageBox.Show(ex.Message, "读取二维码数据出错");
					return;
				}
				...
				if (dlg.ShowDialog() == true)
				{
					...
					try
					{
						...
						//ConnectionPool.Qualified.SaveCheckedDataToExcel(dlg.FileName);
						ExcuteToExcel ETE = new ExcuteToExcel("Sheet1");
						int hr = 1;
						ETE.SetCellValue<string>(hr, 1, "F_SerialNO");
						ETE.SetCellValue<string>(hr, 2, "PRINT_CDOE");
						ETE.SetCellValue<string>(hr, 3, "F_IMEI");
						ETE.SetCellValue<string>(hr, 4, "F_IMSI");
						ETE.SetCellValue<string>(hr, 5, "F_ICCID");
						ETE.SetCellValue<string>(hr, 6, "POSITION");
						ETE.SetCellValue<string>(hr, 7, "F_SerialValidCode");
						

						int rowno = hr;
                        foreach (var F_SerialNO in DataRowDic.Keys)
                        {
							DataRow dr = DataRowDic[F_SerialNO];
							rowno++; 
							ETE.SetCellValue<string>(rowno, 1, F_SerialNO);
							ETE.SetCellValue<string>(rowno, 2, dr["PRINT_CDOE"] + "");
							ETE.SetCellValue<string>(rowno, 3, dr["F_IMEI"] + "");
							ETE.SetCellValue<string>(rowno, 4, dr["F_IMSI"] + "");
							ETE.SetCellValue<string>(rowno, 5, dr["F_ICCID"] + "");
							ETE.SetCellValue<string>(rowno, 6, posDic.ContainsKey(F_SerialNO) ? posDic[F_SerialNO] : "");
							ETE.SetCellValue<string>(rowno, 7, dr["F_SerialValidCode"] + "");
						}
		...
		public async Task BtnSetTime()
		{
			...
			this.DbService.SetOperationTime("F_BD_TIME_TIME", false);
		}


		public void BtnSetTimeSingleFloor(SensorGroupDataModel GroupData)
		{
			this.PageContext.PopupBoxQueryParameter.IsPopupOpen = false;
			UISerialNo.SetSetTime(GroupData);
			this.DbService.SetOperationTime("F_BD_TIME_TIME", GroupData, false);
		}
		...
		private void SM_DataEvent(object sender, CommFactory.DataEventArgs e)
		{
			...
			try
			{
                ...
                foreach (SensorGroupDataModel group in groups)
				{
					...
					//自动判断合格状态
					SensorGroupData src = this.ConnectionPool.Qualified.CurrentProductData.FirstOrDefault(w => w.Key == group.Address).Value;
					if (src != null) {
						for (int j = 0; j < 15; j++)
						{
							DataList[j].IsQualifiedV1 = src.SingleAddressData[j].IsQualifiedV1;
					...
					switch (e.ReadMode)
					{
						...
						case ReadMode.RX_ReadSerialNo:
							Dictionary<string,bool> dicHege = new Dictionary<string,bool>();
							for (int l = 0; l < 15; l++)
							{
								DataList[l].Serial = e.ProductData.SingleAddressData[l].Serial;
								DataList[l].TestSerial(this.SerialCache);
								if(!dicHege.ContainsKey(DataList[l].Serial)) dicHege.Add(DataList[l].Serial,false);
							}
			...
			catch (System.Exception ex)
			{
				...
				/// 最快半秒刷新一次，避免界面刷新太多卡了， 后台推送过来的数据会丢失 不显示，
				if (e.ReadMode == ReadMode.WX_StartRead)
				{
					...
					//关键数据必须显示，查询数据可以延时显示
					if (DateTime.Now - SM_DataEventLastUIRefresh > new TimeSpan(0, 0, 0, 2, 0))
					{
						SM_DataEventLastUIRefresh = DateTime.Now;
						this.PageContextLoadedAll();
					}
				}
				else {
					//关键数据必须显示，查询数据可以延时显示
