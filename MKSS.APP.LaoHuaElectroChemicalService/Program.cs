...
using System.IO;
using MKSS.APP.LaoHuaElectroChemicalService.Job;
...
namespace MKSS.APP.LaoHuaElectroChemicalService
{
    ...
    public class Program
    {
        ...
        ///   老化任务操作类
        /// </summary>
        public static ElectroChemicalService LaohuaService { get; set; }
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    ULogger.Info("初始数据...");
                    DataBus dataBus = ElectroChemicalSaver.SensorServices.BaseDal.Db.
                        SqlQueryable<DataBus>(string.Format("select * from pd_databus ")).ToList().FirstOrDefault();

                    BoardConnectionDataBus connection = new BoardConnectionDataBus(dataBus,null);
                    LaohuaService = connection.CommFactory;
                    //ULogger.Info("第一次刷新任务状态 读取数据...");
