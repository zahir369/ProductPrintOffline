...
namespace MKSS.APP.ZhuiSuService.MQTT
{
    ...
    public class ZhuiSuMqttClient  
    {
        ...
        public async Task<bool> MQ_Init()
        {
            ...
            var mqttModel = ZhuiSuMqttServerConfig.Instance;
                ...
                if (Client == null || !Client.IsConnected)
                {
                    ...
                    Client.ConnectedHandler = new MqttClientConnectedHandlerDelegate(e =>
                   {
                    ...
                    Client.ApplicationMessageReceivedHandler = new MqttApplicationMessageReceivedHandlerDelegate(e =>
                    {
                        ...
                        //Console.WriteLine();
                        // e.ClientId
                        // Console.WriteLine($"TopicName:{e.ApplicationMessage.Topic}Payload:{Encoding.UTF8.GetString(e.ApplicationMessage.Payload)}");
