...
namespace MKSS.APP.LaoHua.Config
{
    public class LaoHuaConfgig
    {
        static string path = AppDomain.CurrentDomain.BaseDirectory + "\\LaoHuaConfgig.xml";
        static LaoHuaConfgig _instance = null;
        public static LaoHuaConfgig Instance {
            get {
                if (_instance == null) {
                    if (File.Exists(path)) {
                        try
                        {
                            _instance = (LaoHuaConfgig)deserialize_from_xml(path, typeof(LaoHuaConfgig));
                        }
                        catch (Exception)
                        {
                        }
                    ...
                    if (_instance == null)
                    {
                        ...
                        _instance.Product.Add(new ProductConfig() { Name = "MK413", Code = 10001, ValueBase = 1001, VoltageValueBase = 20000 });
                        _instance.Product.Add(new ProductConfig() { Name = "MK412", Code = 10001, ValueBase = 1001, VoltageValueBase = 20000 });
                        _instance.Product.Add(new ProductConfig() { Name = "MK411", Code = 10001, ValueBase = 1001, VoltageValueBase = 20000 });
