namespace MKSS.APP.UIBiaoDing.Util
{
    public class SensorGroupData
	{
		...
		public SensormData[] SingleAddressData
		{
			get;
			set;
		}
		...
		public SensorGroupData(DataQualified qui,ushort[] Data, bool LargeValue, byte Address, string Time)
		{
			this.Qualified = qui;
			this.SingleAddressData = new SensormData[]
			{
				new SensormData(),
				new SensormData(),
				new SensormData(),
