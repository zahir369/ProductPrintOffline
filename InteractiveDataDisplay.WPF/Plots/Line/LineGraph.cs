...
namespace InteractiveDataDisplay.WPF
{
    ...
    public class LineGraph : Plot
    {
        ...
        public void Plot(double enx, double eny )
        {
            this.Points.Add(new Point(Convert.ToDouble(enx, CultureInfo.InvariantCulture),
                Convert.ToDouble(eny, CultureInfo.InvariantCulture)));
        }
