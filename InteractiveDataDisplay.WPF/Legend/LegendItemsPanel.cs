...
namespace InteractiveDataDisplay.WPF
{
    ...
    public class LegendItemsPanel : WrapPanel// songguanjun 将 Panel 升级成 WrapPanel 支持多列 多行
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            return result; //return availableSize;  songguanjun 将 Panel 升级成 WrapPanel 支持多列 多行
        }

        // songguanjun 将 Panel 升级成 WrapPanel 支持多列 多行
        /// <summary>
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            { 
                ...
                {
                    x = 0;
                    y = y + c.DesiredSize.Height; 
                    c.Arrange(new Rect(new Point(x, y), c.DesiredSize));// songguanjun 将 Panel 升级成 WrapPanel 支持多列 多行 c.Arrange(new Rect(new Point(0, y), c.DesiredSize));
