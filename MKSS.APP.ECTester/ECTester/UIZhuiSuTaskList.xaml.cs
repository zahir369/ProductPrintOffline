        ...
        private void OpenBatch_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            if (_Batch != null)
            {
                try
                {
                    ...
                    UIZhuiSuModel.Intance.PageContext.UIZhuiSuC10.UIZhuiSuC10SensorsSET.IniData(_Batch, tabs, new System.Diagnostics.Stopwatch());
                    UIZhuiSuModel.Intance.PageContext.UIZhuiSuC10.UIZhuiSuC10SensorsSET.SettingModel.TxtTotalSpan = (int)_Batch.F_AgingEndTime;
                    UIZhuiSuModel.Intance.PageContext.UIZhuiSuC10.UIZhuiSuC10SensorsSET.SettingModel.CurrentTimeSpan = TimeSpan.FromSeconds(_Batch.F_AgingEndTime);
