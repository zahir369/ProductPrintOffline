...
namespace MKSS.APP.O2Tester
{
    ...
    public class UIZhuiSuC10Model {
        ...
        public MKSS.Service.O2Tester.O2TesterService ECService { get; set; }
        ...
        public UIZhuiSuC10Model() {
            ...
            ECService = new Service.O2Tester.O2TesterService();
            ECService.OnNewData += O2TesterService_OnNewData;
        ...
        private void ECService_OnStart(Batch _Batch, List<Sensor> sens, TimeSpan F_AddTime)
        {
            ...
            View.Dispatcher.Invoke(DispatcherPriority.Normal, (ThreadStart)delegate {
                ...
                View.UIZhuiSuC10Chart.UIZhuiSuC10SensorsSET.RefreshButtons(); 
            });
        }
        ...
        private void ECService_OnFinish(Batch _Batch, List<Sensor> sens, TimeSpan F_AddTime)
        {
            ...
            SensorGroupData last = DataCache[DataCache.Count - 1];
            View.Dispatcher.Invoke(DispatcherPriority.Normal, (ThreadStart)delegate {
                SettingModel.Started = false;
                RefrehPageInner(_Batch, last, TimeSpan.FromSeconds(last.F_AddTime), con10);
                View.UIZhuiSuC10Chart.UIZhuiSuC10SensorsSET.RefreshButtons();
                this.View.UIZhuiSuC10Chart.UIZhuiSuC10SensorsSET.RefreshTimeTexts();
                //设置O₂浓度的点
                //this.View.UIZhuiSuC10Chart.UIZhuiSuC10SensorsSET.SetCurrentTime(SettingModel.TxtSpanPoint);
            });
        }
        ...
        void O2TesterService_OnNewData(Model.Batch _Batch, SensorGroupData datas_history, TimeSpan F_AddTime)
        {
