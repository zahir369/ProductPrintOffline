...
{
    public class TmpPrintJinKaXoNB : TmpPrintAbs
    {

        pd_device D1;
        pd_device D2;
        public override string TmpName { get; set; } = "金卡标签新奥包装盒.btw";
        ...
        public override bool PrintBar(bool isPrint = false)
        {

            {
                ...
                try
                {
                    ...
                    if (dev2 != null)
                    {
                        string srrF_SerialNO = TmpPrintJinKaXo.ToSerialNo24(dev2.F_SerialNO);
                        labelFormat.SubStrings.SetSubString("QRCODE2", srrF_SerialNO);
                        labelFormat.SubStrings.SetSubString("TEXT2", srrF_SerialNO);
                    }
                    else
                    {
                        labelFormat.SubStrings.SetSubString("QRCODE2", "000000000000000000000000");
                        labelFormat.SubStrings.SetSubString("TEXT2", "000000000000000000000000");
                    }
