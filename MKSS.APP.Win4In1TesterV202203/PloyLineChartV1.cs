...
namespace MKSS.APP.ECTester
{
    ...
    public class PloyLineChart
    {
        ...
        public static float XRightMargin = 35;
        public static float YBottomMargin = 30;
        public static float YTopMargin = 15;
        ...
        public static string AxisXLabeleFormate(float f) {
            return (TimeSpan.FromSeconds(f)).ToString(@"hh\:mm\:ss");
        }
        public static string AxisYLabeleFormate(float f)
        {
        ...
        public PloyLineChart(System.Windows.Forms.Integration.ElementHost parent)
        {
            Parent = new System.Windows.Controls.Grid();
            parent.Child = Parent;
            ShowLinePoint = true;
        ...
        public void AppendAxises()
        {
            ...
            Font drawFont = new Font("宋体", 12);
            {
                ...
                for (int i = 0; i <= YAxisCount; i++)
                {
                    ...
                    string yLabel = AxisYLabeleFormate(((yLabelMax - yLabelMin) / YAxisCount * i + yLabelMin));
                ...
                for (int i = 1; i <= XAxisCount; i++)
                {
                    ...
                    dc.DrawLine(pen3, p1, p2);
                    //x轴文本
                    string strAxisLabel = AxisXLabeleFormate((this.XLabelMin + (i) * stepData));
    ...
    public class Zooming : System.Windows.Controls.Canvas
    {
            ...
            if (mMode == MouseMode.VIEW)
            {
                ...
                if (ax >= x0 && ax <= x0 + XWidth)
                {
                    ...
                    System.Windows.Media.FormattedText ft =
                        new System.Windows.Media.FormattedText("X:" + PloyLineChart.AxisXLabeleFormate(pd.X) + "",
                    ...
                    dc.DrawRectangle(new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.OrangeRed), pen,
                ...
                if (ay >= y0 && ay <= y0 + YHeight)
                {
                    ...
                    System.Windows.Media.FormattedText ft =
                        new System.Windows.Media.FormattedText("Y:" + PloyLineChart.AxisYLabeleFormate(pd.Y) + "",
                            new System.Globalization.CultureInfo("zh-CHS", false), FlowDirection.LeftToRight, new System.Windows.Media.Typeface("Microsoft YaHei"), 15, System.Windows.Media.Brushes.White);
                    dc.DrawRectangle(new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.OrangeRed), pen,
        ...
        public void PolyText(double ax, double ay)
        {
            ...
            if (Chart.AllDatas.Count > 0)
            {
                ...
                //    {
                //        dc.DrawRectangle(new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.OrangeRed), pen, new System.Windows.Rect(new System.Windows.Point(ax, (i + 1) * y0 + i * Chart.YHeight), new System.Windows.Point(ax + ftXs[i].Width, (i + 1) * y0 + i * Chart.YHeight + ftXs[i].Height)));
                //        dc.DrawText(ftXs[i], new System.Windows.Point(ax, (i + 1) * y0 + i * Chart.YHeight));
                //    }
                //    else
                //    {
                //        dc.DrawRectangle(new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.OrangeRed), pen, new Rect(new System.Windows.Point(ax - ftXs[i].Width, (i + 1) * y0 + i * Chart.YHeight), new System.Windows.Point(ax, (i + 1) * y0 + i * Chart.YHeight + ftXs[i].Height)));
        ...
        public void PolyTestResult(HitTester.HitTestResult result)
        {
            ...
            {
                result.Desc = result.SeriseDatas.Title + ": " + PloyLineChart.AxisYLabeleFormate(pd.Y) + " ，时间：" + PloyLineChart.AxisXLabeleFormate(pd.X) + "" + "";
            }
