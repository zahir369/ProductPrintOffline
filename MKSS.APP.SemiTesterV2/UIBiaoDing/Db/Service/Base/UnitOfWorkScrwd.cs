...
namespace MKSS.Common
{
    public class UnitOfWorkScrwd : IUnitOfWork
    {
        ...
        public SqlSugarClient GetDbClient()
        {
            ...
            {
                ConnectionString = ConfigurationManager.AppSettings["ScrwdConnection"],//必填, 数据库连接字符串
            ...
            string connstr = ConfigurationManager.AppSettings["ScrwdConnection"];// "Data Source=" + BiaoDingSaver.DbNameof(null) + ";Version=3";
