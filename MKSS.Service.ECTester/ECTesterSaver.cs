...
namespace MKSS.Service.ECTester
{
    public class ECTesterSaver
	{
		...
		static SensorGroupDataServices _SensorDataServices = new SensorGroupDataServices();
		static Thread _worker;

		public static SensorServices SensorServices { get { return _SensorServices; } }
		public static SensorGroupDataServices SensorDataServices { get { return _SensorDataServices; } }

		public static void Start( )
		{
			// 任务开始，启动工作线程
			_worker = new Thread(Work);
			_worker.Name = "DbSavingThread";
			_worker.Start();
		}
		...
		public static string DbNameof(Batch _bat) {
			...
			return string.Format(string.Format(AppDomain.CurrentDomain.BaseDirectory + @"data\MKSS.APP.ECTester.{0}.sqlite", _bat.F_BatchId));
		}
		...
		public static Batch Batch
		{
			...
			set
			{
				//DataSource=D:\WORK\Factory\MKSS.APP.ECTester\bin\Debug\net5.0-windows\MKSS.APP.ECTester.sqlite
				if (value != null) {
					...
					_SensorServices = new SensorServices(); 
					 _SensorDataServices = new SensorGroupDataServices();
				}
