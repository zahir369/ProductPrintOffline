...
namespace MKSS.APP.Win4In1Tester
{
	public class Model4In1Tester
	{
		...
		public string[][] PAR_V1 = new string[][] {
			new string[]{ "4", "CO₂", "PPM","" },
			new string[]{ "6", "TVOC/甲醛", "mg/m³", "" },
			new string[]{ "8", "湿度", "%","" },
			new string[]{ "10", "温度", "℃", "" },
			new string[]{ "12", "PM2.5", "μg/m³", "" },
		};

		public string[][] PAR_V2 = new string[][] {
			new string[]{ "4", "CO₂", "PPM", "" },
			new string[]{ "6", "湿度", "%", "" },
			new string[]{ "8", "温度", "℃", "" },
			new string[]{ "10", "PM1.0", "μg/m³", "" },
			new string[]{ "12", "PM2.5", "μg/m³", "" },
			new string[]{ "14", "PM10", "μg/m³", "" },
		};

		public string[][] PAR_V3 = new string[][] {
			new string[]{ "4", "温度", "℃", "" },
			new string[]{ "6", "湿度", "%", "" },
			new string[]{ "8", "PM2.5", "μg/m³", "" },
			new string[]{ "10", "保留", "","" },
			new string[]{ "12", "CO₂", "PPM", "" },
			new string[]{ "14", "保留", "","" },
			new string[]{ "16", "保留", "","" },
			new string[]{ "18", "TVOC/甲醛", "mg/m³", "" },
		};
