...
namespace MKSS.Service.O2Tester
{
    public class O2TesterSaver
	{
		...
		public static string DbNameof(Batch _bat) {
			...
			return string.Format(string.Format(AppDomain.CurrentDomain.BaseDirectory + @"data\MKSS.APP.O2Tester.{0}.sqlite", _bat.F_BatchId));
		}
		...
		public static Batch Batch
		{
			...
			set
			{
				//DataSource=D:\WORK\Factory\MKSS.APP.O2Tester\bin\Debug\net5.0-windows\MKSS.APP.O2Tester.sqlite
				if (value != null) {
